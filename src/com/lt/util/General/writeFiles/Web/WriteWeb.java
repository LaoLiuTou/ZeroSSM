...
public class WriteWeb {
	...
	public  void createFiles(String dirs,String url,String project) throws IOException{
        ...
        if(!file.exists()){
        	...
        	sb.append("  </listener>\n");
        	sb.append("  <filter>\n");
        	sb.append("    <filter-name>struts2</filter-name>\n");
        	sb.append("    <filter-class>org.apache.struts2.dispatcher.ng.filter.StrutsPrepareAndExecuteFilter</filter-class>\n");
        	sb.append("  </filter>\n");
        	sb.append("  <filter-mapping>\n");
        	sb.append("    <filter-name>struts2</filter-name>\n");
        	sb.append("    <url-pattern>/*</url-pattern>\n");
            ...
            sb.append("  <servlet>\n");
            sb.append("  	<servlet-name>FileUpload</servlet-name>\n");
            sb.append("  	<servlet-class>com."+project.toLowerCase()+".servlet.FileUpload</servlet-class>\n");
            sb.append("  </servlet>\n");
            sb.append("  <servlet-mapping>\n");
            sb.append("  	<servlet-name>FileUpload</servlet-name>\n");
            sb.append("  	<url-pattern>/FileUpload</url-pattern>\n");
            sb.append("  </servlet-mapping>\n");
            //不使用webservice
            /*sb.append("   <servlet>\n");
